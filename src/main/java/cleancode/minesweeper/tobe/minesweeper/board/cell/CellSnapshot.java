...
public class CellSnapshot {
    ...
    private final int nearbhLandMineCount;

    private CellSnapshot(CellSnapshotStatus status, int nearbyLandMineCount) {
        this.status = status;
        this.nearbhLandMineCount = nearbyLandMineCount;
    }

    public static CellSnapshot of(CellSnapshotStatus status, int nearbhLandMineCount) {
        return new CellSnapshot(status, nearbhLandMineCount);
    }
    ...
    public int getNearbhLandMineCount() {
        return nearbhLandMineCount;
    }
    ...
    public boolean equals(Object o) {
        ...
        return nearbhLandMineCount == snapshot.nearbhLandMineCount && status == snapshot.status;
    }

    @Override
    public int hashCode() {
        return Objects.hash(status, nearbhLandMineCount);
    }
